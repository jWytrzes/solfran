...
const SectionTemplate = ({ children, noBottomPadding, greyBackground, topPadding }) => {
	return (
		<StyledSection noBottomPadding={noBottomPadding} greyBackground={greyBackground} topPadding={topPadding}>
      {children} 
		</StyledSection>
	);
};
